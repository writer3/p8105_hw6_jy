...
The initial linear regression model was fit with `bwt` as the dependent variable and `.` or all other columns in the dataset as independent variables. Then `step` function was used to perform a stepwise model selection to refine the model. The dafult method, or the backward elimination, was used